...
opt['path']['resume_state'] = 'model_checkpoints/checkpoint/I990000_E187'
opt['datasets']['val']['dataroot'] = 'data/datasets/sample_test_85_256'
...
for i,  val_data in enumerate(val_loader):
    ...
    if i > end_index:
        break
    current_psnr = test_image(val_data, diffusion, "inference_results/test_{}".format(i), scalefactor)
